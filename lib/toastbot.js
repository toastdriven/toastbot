...
Toastbot.prototype.help = method(function(self, nick, text) {
  ...
  for(var offset in self.handlers) {
    var func_name = self.handlers[offset];
...
Toastbot.prototype.dance = method(function(self, nick, text) {
...
Toastbot.prototype.wiki = method(function(self, nick, text) {
  var to_me = self.said_to_me(text);
...
Toastbot.prototype.metar = method(function(self, nick, text) {
  var to_me = self.said_to_me(text);
...
Toastbot.prototype.twitter = method(function(self, nick, text) {
  var to_me = self.said_to_me(text);
